...
// Mute-related icons
export const BellZIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5S10.5 3.17 10.5 4v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zM9 9h4l-4 4h4" stroke="currentColor" strokeWidth="0.5" fill="none" />
        <path d="M10 10h3l-3 3h3" fill="none" stroke="currentColor" strokeWidth="1.2" />
    </svg>
);

export const BellZSmallIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
